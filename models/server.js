...
class Server {
    ...
    constructor() {
        ...
        this.paths = {
            ...
            clienteAgrupacionZona: '/api/clienteAgrupacionZona',
            agrupacionZonaZona: '/api/agrupacionZonaZona',
            clienteAgrupacionCanal: '/api/clienteAgrupacionCanal',
            agrupacionCanalCanal: '/api/agrupacionCanalCanal',
